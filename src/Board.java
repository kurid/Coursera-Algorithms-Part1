...
public class Board {
    ...
    private Stack<Board> neighborsCollection;
    ...
    private void calculateHammingAndManhattan() {
        ...
        manhattan = distanceBetweenBlocksAndGoal;
    }
    ...
    public Iterable<Board> neighbors() {
        if (neighborsCollection != null) return neighborsCollection;
        neighborsCollection = new Stack<>();
